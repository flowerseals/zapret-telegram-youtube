...
<!-- gbzap-brand-lead -->
**Скачать zapret-telegram-youtube** — запрет Discord (голос / RTC) без VPN. Актуальная сборка в [Releases](https://github.com/flowerseals/zapret-telegram-youtube/releases).

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `flowerseals/zapret-telegram-youtube`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/flowerseals/zapret-telegram-youtube/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/flowerseals/zapret-telegram-youtube/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/flowerseals/zapret-telegram-youtube/issues/522)
...
- См. [#765](https://github.com/flowerseals/zapret-telegram-youtube/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/flowerseals/zapret-telegram-youtube/releases/latest) (`zAPREt-DiSCoRd-yoUTUBE-...`)
...
- См. также [#251](https://github.com/flowerseals/zapret-telegram-youtube/discussions/251)
...
- См. также [#252](https://github.com/flowerseals/zapret-telegram-youtube/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/flowerseals/zapret-telegram-youtube/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/flowerseals/zapret-telegram-youtube/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/flowerseals/zapret-telegram-youtube/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/flowerseals/zapret-telegram-youtube/graphs/contributors)
